...
// If win32 then include windows header file else include linux header files
#ifdef WIN32
#include <windows.h>
#else
#include <sys/wait.h>
...
// WSADATA contains information about the Windows Sockets implementation
	...
	// These are the default configurations for the menu

	//g_snprintf (gchar *string, gulong n, gchar const *format, ...);
	// Extra \ are to escape quotes in the format string
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
// This is the main hexchat method
// 30/3/2019
///////////////////////////////////////////////////////////////////////////////////////////////////////
int main (int argc, char *argv[])
{
	...
	// This checks the arguments to hexchat.
	...
	if (argc >= 2)
	{
		for (i = 1; i < argc; i++)
		{
			...
			// Compares a maximum number of 9 characters between the two strings
	...
	// fe_init() from fe-gtk.c is called
    fe_init ();

	//Welcome to hexchat! This program was compiled using Gnome Builder on Ubuntu
	...
	* the startup process to use gtk functions. */
	...
	// These two lines intialize and start hexchat
	xchat_init ();
