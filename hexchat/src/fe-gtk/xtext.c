...
gtk_xtext_button_press (GtkWidget * widget, GdkEventButton * event)
{
	...
	if (event->type == GDK_3BUTTON_PRESS)	/* LINE select */
	{
		...
		// Testing 26/5/2019
		//message("Mouse was clicked 3 times!");
...
dounder:
		...
		// 19/4/2019
		// This is the code that draws a line under url / nick / channel name
		// Changed dest_x to dest_x-6

		// draw directly to window, it's out of the range of our DB */

		gdk_draw_line (xtext->draw_buf, gc, dest_x-6, y, dest_x + str_width - 1, y);
