...
servlist_net_keypress_cb (GtkWidget *wid, GdkEventKey *evt, gpointer tree)
{
	...
	// If SHIFT is pressed along with Up or Down key, the network name is to be moved
	// Can change SHIFT key if needed to CTRL or ALT
...
servlist_open_networks (void)
{
	...
	label6 = gtk_label_new_with_mnemonic (_("_User name (ident):"));
